...
//        Text(text = "Hello $name!", modifier = Modifier.padding(24.dp))
        ...
        Row(modifier = Modifier.padding(24.dp)) {
            ...
            Box(modifier = Modifier.clickable { expanded = !expanded }){
                IconButton(
                    onClick = { expanded = !expanded }, enabled = true
                ) {
                    Icon(
                        imageVector = if (expanded) Icons.Filled.ExpandLess else Icons.Filled.ExpandMore,
                        contentDescription = stringResource(R.string.hi_hi)
                    )
                }
            }
...
//            ) {
//                Text(if(expanded) stringResource(R.string.hi_hi) else stringResource(R.string.no_hi))
//            }
...
//    var shouldShowOnboarding by remember { mutableStateOf(true)}
    ...
    Column(
        ...
        Text(text = stringResource(R.string.glad_easy_codelab))
        Button(
            modifier = Modifier.padding(vertical = 24.dp),
            onClick = onContinueClicked
        ) {
            Text(stringResource(R.string.ccontinue))
        }
    }
}
